...
if(!isOwner) {	//!isOwner) {	
    ...
    if (isGroup && messageText.includes('chat.whatsapp.com')) return;
         var xx = '```'
     conn.sendMessage(delfrom, { text: `> ∂ιηυωн-м∂ αηтι-∂єℓ αℓℓєт\n\n🚫 *ඩිලිට් කලාට පෙන්නනවා ඉතිම් 👀📍 !!*\n\n  🚮 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_\n\n> 🔓 Message Text: ${xx}${messageText}${xx}` });
    //........................................//........................................
    ...
    if (isGroup && messageText.includes('chat.whatsapp.com')) return;
        ...
        await conn.sendMessage(delfrom, { image: fs.readFileSync("./" + type.ext), caption: `> ∂ιηυωн-м∂ αηтι-∂єℓ αℓℓєт\n\n🚫 *ඩිලිට් කලාට පෙන්නනවා ඉතිම් 👀📍 !!*\n\n  🚮 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_\n\n> 🔓 Message Text: ${originalMessage.message.imageMessage.caption}` })
    }else{
        await conn.sendMessage(delfrom, { image: fs.readFileSync("./" + type.ext), caption: `> ∂ιηυωн-м∂ αηтι-∂єℓ αℓℓєт\n\n🚫 *ඩිලිට් කලාට පෙන්නනවා ඉතිම් 👀📍 !!*\n\n  🚮 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_` })
    }       
        }
    ...
    if (isGroup && messageText.includes('chat.whatsapp.com')) return;
        ...
        await conn.sendMessage(delfrom, { video: fs.readFileSync("./" + type.ext), caption: `> ∂ιηυωн-м∂ αηтι-∂єℓ αℓℓєт\n\n🚫 *ඩිලිට් කලාට පෙන්නනවා ඉතිම් 👀📍 !!*\n\n  🚮 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_\n\n> 🔓 Message Text: ${originalMessage.message.videoMessage.caption}` })
           }
    }else{
                let buff =  await ml.download(nameJpg)
                let fileType = require('file-type');
    ...
    await conn.sendMessage(delfrom, { document: fs.readFileSync("./" + type.ext), mimetype: originalMessage.message.documentMessage.mimetype, fileName: originalMessage.message.documentMessage.fileName, caption: `> ∂ιηυωн-м∂ αηтι-∂єℓ αℓℓєт\n\n🚫 *ඩිලිට් කලාට පෙන්නනවා ඉතිම් 👀📍 !!*\n\n  🚮 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_\n`});
    ...
    return await conn.sendMessage(delfrom, { text: `> ∂ιηυωн-м∂ αηтι-∂єℓ αℓℓєт\n\n🚫 *ඩිලිට් කලාට පෙන්නනවා ඉතිම් 👀📍 !!*\n\n  🚮 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_\n` },{quoted: audioq});
    ...
    //await conn.sendMessage(from, { audio: fs.readFileSync("./" + type.ext), mimetype:  originalMessage.message.audioMessage.mimetype, fileName:  `${m.id}.mp3` })	
     const sdata = await conn.sendMessage(delfrom,{sticker: fs.readFileSync("./" + type.ext) ,package: '𝙸𝚃𝚉 𝙼𝙴 𝙳𝙸𝙽𝚄𝚆👀'})
    return await conn.sendMessage(delfrom, { text: `> ∂ιηυωн-м∂ αηтι-∂єℓ αℓℓєт\n\n🚫 *ඩිලිට් කලාට පෙන්නනවා ඉතිම් 👀📍 !!*\n\n  🚮 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_\n` },{quoted: sdata});
    
    }else{
    
    const stdata = await conn.sendMessage(delfrom,{sticker: fs.readFileSync("./" + type.ext) ,package: '𝙸𝚃𝚉 𝙼𝙴 𝙳𝙸𝙽𝚄𝚆👀'})
    return await conn.sendMessage(delfrom, { text: `> ∂ιηυωн-м∂ αηтι-∂єℓ αℓℓєт\n\n🚫 *ඩිලිට් කලාට පෙන්නනවා ඉතිම් 👀📍 !!*\n\n  🚮 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_\n` },{quoted: stdata});
